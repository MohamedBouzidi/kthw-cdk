...
export class KthwStack extends cdk.Stack {
	constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
		...
		let controllerUserData = readFileSync(path.join(__dirname, '../assets/controllerUserData.sh'), 'utf8');
		...
		let workerUserData = readFileSync(path.join(__dirname, '../assets/workerUserData.sh'), 'utf8');
